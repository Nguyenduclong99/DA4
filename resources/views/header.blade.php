<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="{{route('gioithieu')}}"><i class="fa fa-home"></i> 121, thị trấn Hồ, Thuận Thành, Bắc Ninh</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0387678843</a></li>
					</ul>
				</div>
		...
		<div class="header-bottom" style="background-color: #04B4AE;">
			<div class="container">
